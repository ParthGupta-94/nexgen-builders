...
export function Hero() {
  ...
  return (
    <section ref={root} className="relative isolate">
      ...
      {NO_3D ? (
        // Photos-only build: a real project render as the hero background.
        <div className="relative isolate min-h-[100svh] overflow-hidden bg-[var(--color-espresso)]">
          <div className="absolute inset-0 -z-20">
            <Image
              src="/projects/golden-era/day-site-view.jpg"
          ...
          {/* Lighter, left-anchored scrim so the bright aerial stays visible */}
          <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-r from-black/75 via-black/30 to-black/5" />
        ...
        // Pinned scroll-track: the Golden Era cluster assembles behind the text.
