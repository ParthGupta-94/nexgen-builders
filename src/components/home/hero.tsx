...
export function Hero() {
  ...
  return (
    <section ref={root} className="relative isolate">
      ...
      {/* A real project render as the hero background. */}
      <div className="relative isolate min-h-[100svh] overflow-hidden bg-[var(--color-espresso)]">
        <div className="absolute inset-0 -z-20">
          <Image
            src="/projects/golden-era/site-elevation-day.jpg"
            alt="Golden Era Homes — the towers on the boulevard by day"
            fill
            priority
            sizes="100vw"
        ...
        {/* Left-anchored scrim: darkens the text side, keeps the towers visible */}
        <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-r from-black/85 via-black/45 to-black/10" />
        <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-t from-black/55 via-black/10 to-black/20" />

        <Container className="flex min-h-[100svh] flex-col justify-center pb-24 pt-36 sm:pt-40">
